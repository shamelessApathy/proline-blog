...
function mm_jetpack_start_test() {
	...
	if ( file_exists( $file ) && mm_jetpack_bluehost_only() ) {
		if ( ! mm_ab_test_inclusion( 'jetpack-onboarding-v12', md5( 'jetpack-onboarding-v12' ), 30, WEEK_IN_SECONDS * 4 ) ) {
			mm_ab_test_inclusion( 'jetpack-onboarding-exempt-v12', md5( 'jetpack-onboarding-exempt-v11' ), 43, WEEK_IN_SECONDS * 4 );
