...
class Themify_Builder_Import_Export {
	...
	public function builder_import_file_ajaxify(){
		...
		if ( is_multisite() && !is_upload_space_available() ) {
			...
			$output .= sprintf( '<div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn" id="%sthemify-builder-plupload-upload-ui">
								...
								</div>', 'themify_builder_import_file', 'themify_builder_import_file', __('Upload', 'themify'), wp_create_nonce('themify_builder_import_filethemify-builder-plupload') );
