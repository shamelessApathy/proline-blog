...
?>
    ...
    <div<?php echo $this->get_element_attributes( $container_props ); ?>>
        ...
        ?>
        <div class="builder-posts-wrap clearfix loops-wrapper <?php echo apply_filters('themify_builder_module_loops_wrapper', $layout_post) ?>">
            <?php
        ...
        <?php if ('yes' != $hide_page_nav_post): ?>
           <?php echo $this->get_pagenav( '', '', $the_query, $offset_post ) ?>
        <?php endif; ?>
        <?php
